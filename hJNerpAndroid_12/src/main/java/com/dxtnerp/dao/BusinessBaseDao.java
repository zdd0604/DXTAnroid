...
import com.dxtnerp.db.SQLiteWorker.AbstractSQLable;
...
import com.dxtnerp.model.md_ctlm.Ctlm1346;
import com.dxtnerp.model.md_ctlm.Ctlm1347;
import com.dxtnerp.model.md_ctlm.Ctlm1347JsonPrototype;
import com.dxtnerp.model.md_ctlm.Ctlm4203;
import com.dxtnerp.model.MenuContent;
import com.dxtnerp.model.NBusinessTableCreateModel;
import com.dxtnerp.util.StringUtil;
import com.dxtnerp.util.myscom.ObjectUtils;
...
public class BusinessBaseDao extends BaseDao {
    ...
    public static final BusinessData getBusinessData(String idTable,
        ...
        for (int i = 0; i < result.size(); i++) {
            com.dxtnerp.util.Log.i("info", "第" + i + "个line_no=="
    ...
    public static final List<Ctlm1108> selectCtlm1108(String id_clerk,
        ...
        sb.append("select * from ")
                ...
                .append("' ");
        com.dxtnerp.util.Log.e("show", sb.toString());
    ...
    public static final void updateCtlm1108(String id_clerk,
        ...
        try {
            ...
            sbuffer.append("' ");
            com.dxtnerp.util.Log.e("show", sbuffer.toString());
